...
public class UserController {
	...
	@GetMapping
	public ResponseEntity<?> getUsers(@RequestParam String sortType, @RequestParam String sortOrder,
			@RequestParam String limit, @RequestParam String offset) {

		validateInput(UserQueryConstants.SORT_TYPE, sortType);
		validateInput(UserQueryConstants.SORT_ORDER, sortOrder);
		validateInput(UserQueryConstants.LIMIT, limit);
		validateInput(UserQueryConstants.OFFSET, offset);
