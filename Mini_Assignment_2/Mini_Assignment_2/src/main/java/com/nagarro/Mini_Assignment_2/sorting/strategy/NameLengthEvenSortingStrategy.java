...
@Configuration
public class NameLengthEvenSortingStrategy implements UserSortingStrategy {

	private final UserRepository repo;

	@Autowired
	public NameLengthEvenSortingStrategy(UserRepository repo) {
		this.repo = repo;
	...
	public List<User> applySort() {
		return repo.findAllByNameLengthIsEven();
	}
}
