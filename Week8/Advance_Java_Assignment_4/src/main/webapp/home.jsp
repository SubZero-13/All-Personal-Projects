...
<body>
 ...
 <div class="container-fluid">
  <div class="fixed-header d-flex justify-content-between align-items-center bg-dark text-light p-3">
    <div class="text-center">
      <h2><b>Search Your Favorite T-shirts</b></h2>
    </div>
  ...
  <div class="row justify-content-center mt-5">
    <div class="main-content col-md-6 mt-4 p-4 rounded shadow-lg">
      <form action="Search" method="post">
        <div class="form-group row" >
          <label for="Color" class="col-md-2 col-form-label text-md-end font-weight-bold">Color:</label>
          <div class="col-md-8" >
            <input type="text" class="form-control" id="Color" name="colour">
          </div>
        </div>
        <div class="form-group row">
			<legend class="col-md-2 col-form-label pt-0 font-weight-bold" style="margin-left:1.3rem;">Size:</legend>
          <div class="col-md-8" style="margin-left:1.5rem;">
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="size" id="S" value="S" checked>
              <label class="form-check-label" for="S" style="font-weight: bold;">S</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="size" id="M" value="M">
              <label class="form-check-label" for="M" style="font-weight: bold;">M</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="size" id="L" value="L">
              <label class="form-check-label" for="L" style="font-weight: bold;">L</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="size" id="XL" value="XL">
              <label class="form-check-label" for="XL" style="font-weight: bold;">XL</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="size" id="XXL" value="XXL">
              <label class="form-check-label" for="XXL" style="font-weight: bold;">XXL</label>
            </div>
          </div>
        </div>
        ...
        <fieldset class="row mb-3">
          ...
          <div class="col-sm-8">
            <div class="form-check-inline">
              <input class="form-check-input" type="radio" name="gender" id="MaleGender" value="M" checked>
    ...
    <div class="form-check-inline">
      <input class="form-check-input" type="radio" name="gender" id="OtherGender" value="U">
      <label class="form-check-label" for="OtherGender">U</label>
    </div>
  </div>
</fieldset>

<fieldset class="row mb-3">
  <legend class="col-form-label col-2 pt-0 mx-4 font-weight-bold">Output Preference</legend>
  <div class="col-sm-8">
    <div class="form-check-inline">
      <input class="form-check-input" type="radio" name="outputPreference" id="PriceRadio" value="1" checked>
      <label class="form-check-label" for="PriceRadio">Price</label>
    </div>
    <div class="form-check-inline">
      <input class="form-check-input" type="radio" name="outputPreference" id="RatingRadio" value="2">
      <label class="form-check-label" for="RatingRadio">Rating</label>
    </div>
    <div class="form-check-inline">
      <input class="form-check-input" type="radio" name="outputPreference" id="BothRadio" value="3">
	...
	<script>
    document.getElementById("btn").addEventListener("submit", displayError);

    function displayError() {
        <% if(tshirts == null || tshirts.size() == 0) { %>
            document.getElementById("noTShirtMsg").innerHTML = "Tshirt is not available";
            document.getElementById("noTShirtMsg").style.color = "red";
            return false;
        <% } else { %>
            document.getElementById("noTShirtMsg").innerHTML = "";
        <% } %>
        return true;
    }
</script>
